                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update',['id' => $user->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="create_date" type="date" class="form-control @error('create_date	') is-invalid @enderror" name="create_date"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email_sent_date" type="date" class="form-control @error('email_sent_date') is-invalid @enderror" name="email_sent_date"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="company_source" type="text" class="form-control @error('company_source') is-invalid @enderror" name="company_source"  >
                        ...
                        <div class="row mb-3">
                            <label for="contact_source" class="col-md-4 col-form-label text-md-end">{{ __('Company Source') }}</label>

                            <div class="col-md-6">
                                <input id="contact_source" type="text" class="form-control @error('company_source') is-invalid @enderror" name="company_source"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="database_creator_name" type="text" class="form-control @error('database_creator_name') is-invalid @enderror" name="database_creator_name"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="technology" type="text" class="form-control @error('technology') is-invalid @enderror" name="technology"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="client_speciality" type="text" class="form-control @error('client_speciality') is-invalid @enderror" name="client_speciality"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="client_name" type="text" class="form-control @error('client_name') is-invalid @enderror" name="client_name"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email_response_1" type="text" class="form-control @error('email_response_1') is-invalid @enderror" name="email_response_1"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email_response_2" type="text" class="form-control @error('email_response_2') is-invalid @enderror" name="email_response_2"  >
                        ...
                        <div class="row mb-3">
                            <label for="followup" class="col-md-4 col-form-label text-md-end">{{ __('Rating') }}</label>

                            <div class="col-md-6">
                                <input id="followup" type="text" class="form-control @error('followup') is-invalid @enderror" name="followup"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="linkedin_link" type="text" class="form-control @error('linkedin_link') is-invalid @enderror" name="linkedin_link"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="employee_count" type="text" class="form-control @error('employee_count') is-invalid @enderror" name="employee_count"  >
